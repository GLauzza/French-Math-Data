...
data = data.rename_column("expected_answer", "answer")
data = data.add_column("solution", [sample["messages"][1]["content"] for sample in data])

data.save_to_disk("/lustre/fsn1/projects/rech/knb/ukq43aj/Datasets/Nemotron-Math-v2-low")